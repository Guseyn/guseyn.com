          ...
          new PrettyPage(
            new Page(
              ...
              new Head(
                ...
                new Script('/../js/bundle.min.js', 'type="text/javascript" async'),
                new Script('/../js/highlight.pack.js', 'type="text/javascript" async'),
                new Script('/../js/youtube.js', 'type="text/javascript" async')
              ),
              new Body(
                'class="main"',
