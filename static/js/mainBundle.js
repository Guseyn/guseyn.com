...
module.exports = {
  ...
  HtmlFromMd: require('./src/HtmlFromMd')

}

},{"./src/HtmlFromMd":26}],26:[function(require,module,exports){
'use strict'
...
},{"@page-libs/cutie":16,"showdown":29}],27:[function(require,module,exports){
"use strict";
...
},{"./Unit":27}],29:[function(require,module,exports){
...
},{"@page-libs/unit":28}],31:[function(require,module,exports){
'use strict';
...
window.onload = function () {
  ...
  if (cutiesDetailsBox) {
    new ElementWithInnerHTML(cutiesDetailsBox, new HtmlFromMd(new ResponseBody(new ResponseFromAjaxRequest({
      url: '/../../md/cuties-details.md',
      method: 'GET'
    })), {
      'tables': true
    })).call();
  ...
  var pageLibsDetailsBox = document.getElementById('page-libs-details');

  if (pageLibsDetailsBox) {
    new ElementWithInnerHTML(pageLibsDetailsBox, new HtmlFromMd(new ResponseBody(new ResponseFromAjaxRequest({
      url: '/../../md/page-libs-details.md',
      method: 'GET'
    })), {
      'tables': true
    })).call();
...
},{"./DayNightButton":30,"@page-libs/ajax":6,"@page-libs/dom":24,"@page-libs/md2html":25}]},{},[30,31]);
