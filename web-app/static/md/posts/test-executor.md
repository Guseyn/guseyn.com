...
[This library](https://github.com/Guseyn/node-test-executor) is based on [Async Tree Pattern](https://cdn.guseyn.com(/pdf/Async_Tree_Pattern.pdf)). And that's how you can use it:
