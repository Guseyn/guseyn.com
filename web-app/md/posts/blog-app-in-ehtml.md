...
You can find the app that I am going describe in this article in GitHub [here](https://github.com/Guseyn/simple-oauth-app).  You can also watch the demo [here](http://www.youtube.com/watch?feature=player_embedded&v=lOf0NkNtWzI).
